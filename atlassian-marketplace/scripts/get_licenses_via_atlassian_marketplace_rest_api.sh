...
COMMAND="curl -v -u $ATLASSIAN_MARKETPLACE_NAME:$ATLASSIAN_MARKETPLACE_PASS https://marketplace.atlassian.com/rest/2/vendors/$VENDOR_ID/reporting/licenses/export"
