...
#COMMAND="curl -v -u $ATLASSIAN_MARKETPLACE_NAME:$ATLASSIAN_MARKETPLACE_PASS https://marketplace.atlassian.com/rest/2/vendors/$VENDOR_ID/reporting/sales/transactions?startDate=2018-09-11;endDate=2018-09-17"
COMMAND="curl -v -u $ATLASSIAN_MARKETPLACE_NAME:$ATLASSIAN_MARKETPLACE_PASS https://marketplace.atlassian.com/rest/2/vendors/$VENDOR_ID/reporting/sales/transactions"
